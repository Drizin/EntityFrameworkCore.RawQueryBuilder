...
namespace EntityFrameworkCore.RawQueryBuilder
{
    ...
    public class CommandBuilder<TEntity> : ICompleteCommand<TEntity>
        where TEntity : class
    {
        #region Members
        ...
        public CommandBuilder(DbSet<TEntity> dbSet)
        {
            _dbSet = dbSet;
        ...
        /// </summary>
        public CommandBuilder<TEntity> AddParameter(string parameterName, object parameterValue = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null, byte? precision = null, byte? scale = null)
        {
        ...
        /// </summary>
        /// <param name="statement">SQL command</param>
        public CommandBuilder<TEntity> AppendLine(FormattableString statement)
        {
