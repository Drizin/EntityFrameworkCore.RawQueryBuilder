...
{
    /// <summary>
    /// SQL parameter which is passed to EF
    /// </summary>
    ...
    public class ParameterInfo
    {
        ...
        /// <summary>
        /// Parameters added through string interpolation usually do not need to define their DbType, and EF will automatically detect the correct type, <br />
        /// but it's possible to explicitly define the DbType (which EF will map to corresponding type in your database)
        /// </summary>
        public DbType? DbType { get; set; }

        /// <summary>
        /// Parameters added through string interpolation usually do not need to define their Size, and EF will automatically detect the correct size, <br />
        ...
        /// <summary>
        /// Parameters added through string interpolation usually do not need to define this, as EF will automatically calculate the correct value
        /// </summary>
