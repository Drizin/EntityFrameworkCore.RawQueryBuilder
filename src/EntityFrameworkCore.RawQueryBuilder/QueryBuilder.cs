...
namespace EntityFrameworkCore.RawQueryBuilder
{
    ...
    /// </summary>
    public class QueryBuilder<TEntity> : ICompleteCommand<TEntity>
        where TEntity : class
    {
        #region Members
        private readonly Filters _filters = new Filters();
        private readonly List<string> _froms = new List<string>();
        private readonly CommandBuilder<TEntity> _commandBuilder;
        #endregion
        ...
        {
            _commandBuilder = new CommandBuilder<TEntity>(dbSet);
        }
        ...
        /// </param>
        public QueryBuilder(DbSet<TEntity> dbSet, FormattableString query)
        {
            _commandBuilder = new CommandBuilder<TEntity>(dbSet, query);
        }
        #endregion
        ...
        /// </summary>
        public virtual QueryBuilder<TEntity> Where(Filter filter)
        {
        ...
        /// Adds a new condition to where clauses.
        /// </summary>
        public virtual QueryBuilder<TEntity> Where(Filters filters)
        {
        ...
        /// Parameters embedded using string-interpolation will be automatically converted into EF parameters.
        /// </summary>
        public virtual QueryBuilder<TEntity> Where(FormattableString filter)
        {
        ...
        /// </summary>
        public DbSet<TEntity> DbSet => _commandBuilder.DbSet;
        #endregion
        ...
        public QueryBuilder<TEntity> Append(FormattableString statement)
        {
        ...
        /// </summary>
        /// <param name="statement">SQL command</param>
        public QueryBuilder<TEntity> AppendLine(FormattableString statement)
        {
